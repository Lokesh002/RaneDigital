...
class GeneratePFUScreen extends StatefulWidget {
  @override
  _GeneratePFUScreenState createState() => _GeneratePFUScreenState();
}

class _GeneratePFUScreenState extends State<GeneratePFUScreen> {
  String selectedLine;
