...
class EnterQPCRDataScreen extends StatefulWidget {
  Line selectedLine;
  String dept;
  Machines selectedMachine;
  EnterQPCRDataScreen(this.selectedLine, this.selectedMachine, this.dept);

  @override
  _EnterQPCRDataScreenState createState() => _EnterQPCRDataScreenState();
}
...
class _EnterQPCRDataScreenState extends State<EnterQPCRDataScreen> {
                          ...
                          if (_formKey.currentState.validate()) {
                            if (!(!_impactProduction &&
                              ...
                              if (_image != null) {
                                ...
                                var data =
                                    await networking.postData('QPCR/generate', {
                                  "problem": problem,
